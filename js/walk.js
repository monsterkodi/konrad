...
(function() {
  var _, argDir, config, error, log, ref, should, slash, target, walk, walkdir,
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  ref = require('kxk'), walkdir = ref.walkdir, slash = ref.slash, error = ref.error, log = ref.log, _ = ref._;
