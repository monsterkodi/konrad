...
(function() {
  var _, argDir, args, build, colors, compile, config, empty, error, fs, log, pretty, ref, runcmd, should, slash, str, target, writeCompiled;

  ref = require('kxk'), args = ref.args, slash = ref.slash, empty = ref.empty, fs = ref.fs, colors = ref.colors, str = ref.str, error = ref.error, _ = ref._;
